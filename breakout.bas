...
35 LET LIVES=3
45 REM ** INIT VARS **
50 PRINT AT 2,10; INK 7; BRIGHT 1; PAPER 2; "ZX BREAKOUT";BRIGHT 0; PAPER 7; INK 1; AT 6,0; "Taken from.."; AT 8,0;"Code Club Book": PAUSE 0
100 GOSUB 300; REM init
120 GOSUB 500; REM menu
130 GOSUB 1000; REM main loop
200 GOTO 30
...
1060 IF timer=5 THEN GOSUB 3000
1070 IF ball=1 THEN GOSUB 4000
...
3025 LET ir=4
3030 PRINT AT p+2,n+4; INK 0; PAPER ir;"_":
3050 NEXT p 
3060 NEXT n 
3070 LET timer = 6
3100 RETURN
...
4015 IF y$="_" THEN LET score = score + 1: BEEP 0.008,0: LET score2=score2+1: LET vy=-vy*speed
...
4080 IF lives=0 THEN GOSUB 5000
4090 IF score2>=70 THEN GOSUB 6000: REM Next level:
4200 RETURN
5000 REM **** restart
